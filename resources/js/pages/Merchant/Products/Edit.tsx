        ...
        <MerchantLayout
            header={
                <div className="flex items-center justify-between">
                    <div>
                        <h2 className="text-xl leading-tight font-semibold text-gray-800 dark:text-gray-200">Edit Product</h2>
                        <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">Update product information</p>
                    </div>
            ...
            <div className="max-w-2xl">
                <div className="rounded-lg bg-white shadow dark:bg-gray-800">
                    <div className="border-b border-gray-200 px-6 py-4 dark:border-gray-700">
                        <h3 className="text-lg font-medium text-gray-900 dark:text-white">Edit Product Information</h3>
                    </div>
                        ...
                        {({ errors, processing, wasSuccessful }) => (
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    />
                                    {errors.name && hasSubmitted && <div className="mt-1 text-sm text-red-600 dark:text-red-400">{errors.name}</div>}
                                </div>
                                ...
                                {wasSuccessful && (
                                    <div className="rounded-md border border-green-200 bg-green-50 p-4 dark:border-green-700 dark:bg-green-900">
                                        <div className="text-sm text-green-800 dark:text-green-200">Product updated successfully!</div>
                                    </div>
                                )}
                            </div>
                        )}
                    ...
                    <div className="mt-6 border-t border-gray-200 p-6 dark:border-gray-700">
                        <ImageUpload productId={product?.id || ''} existingImages={images} onImagesUpdate={setImages} maxImages={5} />
                    </div>
                </div>
            </div>
        </MerchantLayout>
